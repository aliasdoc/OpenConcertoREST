 ...
 * Class OC_JOURNAL
 */
class OC_JOURNAL extends OC_BASE_MODEL
{
	 ...
	 * @return $this
	 */
	public function setPARDEFAUT($value) {
		$this->PAR_DEFAUT = $value;
		return $this;
	}
	 ...
	 * @return $this
	 */
	public function setTYPEBANQUE($value) {
		$this->TYPE_BANQUE = $value;
		return $this;
	}
