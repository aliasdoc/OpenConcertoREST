...
/**
 * Class OC_ARTICLEFOURNISSEUR
 */
class OC_ARTICLEFOURNISSEUR extends OC_BASE_MODEL
{
    ...
    protected $fillable = [
        ...
        'PV_TTC',
        'ID_TAXE',
        'ID_FAMILLE_ARTICLE_FOURNISSEUR',
	 ...
	 * @return mixed
	 */
	public function getIDFAMILLEARTICLEFOURNISSEUR() {
		return $this->ID_FAMILLE_ARTICLE_FOURNISSEUR;
	}
	 ...
	 * @return $this
	 */
	public function setIDFAMILLEARTICLEFOURNISSEUR($value) {
		$this->ID_FAMILLE_ARTICLE_FOURNISSEUR = $value;
		return $this;
	}
