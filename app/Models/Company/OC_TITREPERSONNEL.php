...
/**
 * Class OC_TITREPERSONNEL
 */
class OC_TITREPERSONNEL extends OC_BASE_MODEL
{
    protected $table = 'TITRE_PERSONNEL';
	 ...
	 * @return $this
	 */
	public function setSEXEM($value) {
		$this->SEXE_M = $value;
		return $this;
	}
