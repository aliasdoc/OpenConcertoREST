...
/**
 * Class OC_CUMULSCONGE
 */
class OC_CUMULSCONGE extends OC_BASE_MODEL
{
    protected $table = 'CUMULS_CONGES';
	 ...
	 * @return $this
	 */
	public function setRESTANT($value) {
		$this->RESTANT = $value;
		return $this;
	}
	 ...
	 * @return $this
	 */
	public function setACQUIS($value) {
		$this->ACQUIS = $value;
		return $this;
	}
