...
/**
 * Class OC_DEPARTEMENT
 */
class OC_DEPARTEMENT extends OC_BASE_MODEL
{
	 ...
	 * @return $this
	 */
	public function setCHEFLIEU($value) {
		$this->CHEF_LIEU = $value;
		return $this;
	}
	 ...
	 * @return $this
	 */
	public function setREGIONADMIN($value) {
		$this->REGION_ADMIN = $value;
		return $this;
	}
