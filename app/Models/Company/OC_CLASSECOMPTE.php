...
/**
 * Class OC_CLASSECOMPTE
 */
class OC_CLASSECOMPTE extends OC_BASE_MODEL
{
    protected $table = 'CLASSE_COMPTE';
	 ...
	 * @return mixed
	 */
	public function getTYPENUMEROCOMPTE() {
		return $this->TYPE_NUMERO_COMPTE;
	}
	 ...
	 * @return $this
	 */
	public function setTYPENUMEROCOMPTE($value) {
		$this->TYPE_NUMERO_COMPTE = $value;
		return $this;
	}
